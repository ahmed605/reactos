...
typedef
NTSTATUS NTAPI
DXGADAPTER_OPENADAPTER(_Inout_ D3DKMT_OPENADAPTERFROMHDC* unnamedParam1);

typedef DXGADAPTER_OPENADAPTER *PDXGADAPTER_OPENADAPTER;
...
{
    PDXGADAPTER_OPENADAPTER RxgkIntPfnOpenAdapter;
