...
@ stdcall -stub -version=0x600+ NtAlpcCreateSectionView(ptr long ptr)
@ stdcall -stub -version=0x600+ NtAlpcCreateSecurityContext(ptr long ptr)
@ stdcall -stub -version=0x600+ NtAlpcDeletePortSection(ptr long ptr)
@ stdcall -stub -version=0x600+ NtAlpcDeleteSectionView(ptr long ptr)
@ stdcall -stub -version=0x600+ NtAlpcDeleteSecurityContext(ptr long ptr)
@ stdcall -stub -version=0x600+ NtAlpcDisconnectPort(ptr long)
...
@ stdcall -stub -version=0x600+ NtAlpcSetInformation(ptr ptr ptr long)
