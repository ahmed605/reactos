...
#define WPFSelectAnyDecl EXTERN_C __declspec(selectany)
#else
#define WPFSelectAny EXTERN_C __declspec(selectany)
#define WPFSelectAnyDecl __declspec(selectany)
#endif
